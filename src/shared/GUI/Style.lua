...
--[[
	Note that this file can't be preloaded because its initialization requires Settings to be initialized
]]
...
local Roact: Roact = _G.Game.PreLoad(game.ReplicatedFirst.Modules.Roact)
